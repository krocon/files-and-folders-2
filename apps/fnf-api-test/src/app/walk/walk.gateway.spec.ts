...
import {WalkGateway} from '@fnf/fnf-api/src/app/walk/walk.gateway';
...
import {FileWalker} from '@fnf/fnf-api/src/app/walk/file-walker';

// Mock FileWalker
jest.mock('@fnf/fnf-api/src/app/walk/file-walker');
